...
- 正式 `report.html` 必须通过 `scripts/render_report.py --state design-buff-reviews/<review-slug>/review-state.json --slots .design-buff/<review-slug>/report-slots.json` 生成，不要直接手写最终 HTML
